...
- [x] Реализовать policy follow-up retrieval для вопросов, продолжающих предыдущую тему.
- [x] Реализовать policy для уточняющих вопросов по уже найденному документу.
- [x] Реализовать policy для вопросов `какой пункт?`, `где это написано?`, `приведи ссылку`.
- [x] Реализовать policy для вопросов `дополни ответ`, `продолжи`, `что еще`.
- [x] Реализовать policy, при которой новый follow-up может поднимать дополнительные locator hits и retrieval units.
- [x] Реализовать policy, при которой предыдущий `partial` ответ может стать `direct` после follow-up.
- [x] Реализовать policy смены контекста, если пользователь явно уводит разговор в другой документ или другую тему.
- [x] Добавить unit/integration tests на сценарии:
